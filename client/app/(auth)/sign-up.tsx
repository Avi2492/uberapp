...
const SignUpPage = () => {
	...
	const onPressVerify = async () => {
		...
		try {
			...
			console.log("Error is Here" + err.errors[0].longMessage);
	...
	return (
		...
		// 					Verification
		// 				</Text>
		// 				<Text className=" font-JakartaExtraBold mb-5">
		...
		// 					Verified
		// 				</Text>
		// 				<Text className="text-base text-gray-400 text-center font-Jakarta mt-2">
